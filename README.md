...
ยินดีต้อนรับสู่ **"เกมผจญภัยระบบร่างกายมนุษย์"**\! เว็บแอปพลิเคชันเกมเพื่อการศึกษา (Educational Game) แบบ Single-file ที่ออกแบบมาเป็นพิเศษสำหรับนักเรียนชั้นม.3.2 เพื่อให้การเรียนรู้วิชาวิทยาศาสตร์เรื่องระบบร่างกายเป็นเรื่องสนุก น่าติดตาม และเข้าถึงง่ายบนโทรศัพท์มือถือ (Mobile-First)
